import { generateDatesFromYearBegnning } from "../utils/generate-dates-from-your-beginning"
            ...
            <div className="grid grid-rows-7 grid-flow-col gap-3">
                ...
                {amountOfDaysToFill > 0 && Array.from ({ length: amountOfDaysToFill }).map((_, i) => {
                    return (
                        <div 
                            key={i} 
                            className="w-10 h-10 bg-zinc-800 rounded-lg opacity-40 cursor-not-allowed">    
                        </div>
                    )
                })}
            </div>
